                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink href={route('feature4.index')} active={route().current('feature4.index')}>
                                    Feature 4
                                </NavLink>
                            </div>
                        </div>
                        ...
                        <div className="hidden sm:flex sm:items-center sm:ms-6 gap-3">
                            <span className='flex gap-3'>
                                <img
                                    src="/laravel-react-saas/public/img/coin.png" className="w-[20px]" alt=''
                                />
                                {user.available_credits} Credits
                            </span>
                            <Link href={ route('credits.index') } className='py-1 px-3 rounded border transition-colors hover:text-gray-800'>
                                Get More
                            </Link>
